...
public class SwerveModule {
    ...
    public SwerveModuleState getState() {
        // double angle = optimized ? AngleUtil.circleMod(getAngle() + 180) - 180 :
        // getAngle();
        return new SwerveModuleState((driveEncoder.getVelocity() / SwerveConstants.GEAR_RATIO) * SwerveConstants.WHEEL_DIAMETER * Math.PI / 60,
